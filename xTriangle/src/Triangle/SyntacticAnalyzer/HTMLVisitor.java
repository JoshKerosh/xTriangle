...
public class HTMLVisitor implements Visitor{
    ...
    // <editor-fold defaultstate="collapsed" desc=" HTML Creation Methods ">
    
    /**
     * Create a Nullary Markup (doesn't have any children).
     * @param caption The markup caption (text to be shown when the html is created).
     * @return html text.
     */
